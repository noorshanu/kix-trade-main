...
function Hero() {
  return (
    <section className=" relative">
      ...
      <div className=" absolute w-full top-[28%] sm:-top-[54%] overflow-y-hidden">
        <video autoPlay loop muted playsInline className="w-full h-full opacity-40">
      ...
      <div className=" absolute top-[16%] sm:top-[-4%] left-0 right-0 z-[2]  ">
        <video
          autoPlay
          loop
          muted
          ...
          className="w-full max-w-lg h-full mx-auto "
        >
      ...
      <div className="container-wrapper relative z-50">
        <div className=" my-4">
          <img src="images/logo.png" alt="" className=" mx-auto h-[2rem] sm:h-[1.5rem]" />
        </div>
        <div>
          <img src="images/tredtext.png" alt="" className=" mx-auto py-1 -mt-3  sm:-mt-0 sm:py-4 sm:h-[4.5rem] h-[3.5rem] " />
        </div>
      ...
      <div className=" absolute -top-[46%] sm:-top-[45%] -left-[30px]  sm:-left-[14px] z-[2] hidden sm:block  ">
        ...
        >
          ...
          <img src="images/free.png" alt="" className="sm:h-[16rem] h-[9rem] relative " />
          ...
          <img src="images/now.png" alt="" className="sm:h-[16rem] h-[9rem]" />
        </div>
      </div>
    </section>
  );
